...
#path to timestamp file with last db timestamp
$last_database_created = Get-content z:\automation_backups\last_database_created
...
foreach($db in $databases){
   ...
   #$RelocateLog = New-Object Microsoft.SqlServer.Management.Smo.RelocateFile($log_string , $log_path) 
    ...
    $db_file = 'z:\automation_backups\' + $db + '_' + $last_database_created + '.bak'
